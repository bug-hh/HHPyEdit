...
class myEditor(QMainWindow):
    ...
    def createTrayIcon(self):
        ...
        self.trayIconMenu.addAction(
            QAction(QIcon(self.appfolder + "/icons/python2"), "about PyEdit", self, triggered=self.about))
        self.trayIconMenu.addSeparator()
        for i in range(self.MaxRecentFiles):
            self.trayIconMenu.addAction(self.recentFileActs[i])
        self.trayIconMenu.addSeparator()
        self.trayIconMenu.addAction(
            QAction(QIcon(self.appfolder + "/icons/quit"), "Exit", self, triggered=self.handleQuit))
